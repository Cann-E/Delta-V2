# 📦 Migration auto-generated by Django on 2025-03-17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0012_alter_user_first_name_max_length'),  # 🔗 Depends on auth app migration
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                #  Group and permission relations
            ...
            managers=[
                ('objects', django.contrib.auth.models.UserManager()),  # 🧠 Default user manager
            ],
        ),

        #  Request model for major/address changes
        migrations.CreateModel(
            name='Request',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
